...
# - Interactive setup of GitHub Projects with automated workflows
# - Creates project files and GitHub Actions integration
#
# Integration:
# - Mirrors functionality of bash/create-project.sh
# - Used by projectize.md template for PowerShell environments
# - Follows Windows PowerShell conventions and error handling
#
# Files Created:
...
#
# Usage:
#   .\create-project.ps1 "My new project description"
#   .\create-project.ps1 -Json "My new project description"
#
...
$ProjectDescription = $Args -join " "

if (-not $ProjectDescription) {
    Write-Error "Usage: $($MyInvocation.MyCommand.Name) [-Json] <project_description>"
    exit 1
}
